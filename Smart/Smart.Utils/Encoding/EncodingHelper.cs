...
namespace Smart.Core.Utils
{
    ...
    public class EncodingHelper
    {
        ...
        /// <code>
        ///  EncodingHelper ide = new EncodingHelper();
        ...
        /// <code>
        ///  EncodingHelper ide = new EncodingHelper();
        ///  Response.Write(ide.GetEncodingName(EncodingHelper.ToSByteArray(System.Text.Encoding.GetEncoding("gb2312").GetBytes("Lion互动网络(www.lionsky.net)")))); 
        /// </code>
        /// </example>
