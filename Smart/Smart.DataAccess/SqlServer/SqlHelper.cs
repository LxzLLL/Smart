...
namespace Smart.DataAccess.SqlServer
{
    ...
    public class SqlHelper : IDbHelper
    {
        ...
        {
            DbTransaction transaction = SqlOperator.BeginTransaction(this._connection);
            return transaction;
        }
        ...
        {
            DataSet ds = SqlOperator.ExecuteDataset(this._connection, commandType, commandText);
            return ds;
        }
        ...
        {
            DataSet ds = SqlOperator.ExecuteDataset(this._connection, commandType, commandText, (SqlParameter[])parameterValues);
            return ds;
        }
        ...
        {
            int result = SqlOperator.ExecuteNonQuery(this._connection, commandType, commandText);
            return result;
        }
        ...
        {
            int result = SqlOperator.ExecuteNonQuery((SqlTransaction)trans, commandType, commandText);
            return result;
        }
        ...
        {
            int result = SqlOperator.ExecuteNonQuery(this._connection, commandType, commandText, (SqlParameter[])parameterValues);
            return result;
        }
        ...
        {
            int result = SqlOperator.ExecuteNonQuery((SqlTransaction)trans, commandType, commandText, (SqlParameter[])parameterValues);
            return result;
        }
        #endregion
        ...
        {
            IDataReader dr = SqlOperator.ExecuteReader(this._connection, commandType, commandText);
            return dr;
        }
        ...
        {
            IDataReader dr = SqlOperator.ExecuteReader(this._connection, commandType, commandText, (SqlParameter[])parameterValues);
            return dr;
        }
        ...
        {
            object result = SqlOperator.ExecuteScalar(this._connection, commandType, commandText);
            return result;
        }
        ...
        {
            object result = SqlOperator.ExecuteScalar(this._connection, commandType, commandText, (SqlParameter[])parameterValues);
            return result;
        }
        ...
        {
            object result = SqlOperator.ExecuteScalar((SqlTransaction)trans, commandType, commandText);
            return result;
        }
        ...
        {
            object result = SqlOperator.ExecuteScalar((SqlTransaction)trans, commandType, commandText, (SqlParameter[])parameterValues);
            return result;
        }
